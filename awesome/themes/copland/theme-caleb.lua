...
local mytextclock = wibox.widget.textclock("<span font='Tamzen 5'> </span>%a %b %d, %Y - %H:%M:%S", 1)
...
theme.weather = lain.widget.weather({
    city_id = 5069773, -- placeholder (London)
})

-- Wireless
theme.wireless = net_widgets.wireless({
	interface = "wlp12s0",
	font      = "Tamzen",
	onclick   = "terminator -e 'sudo wifi-menu'" 
})
-- them.wireless
local wirelesswidget = wibox.container.margin(theme.wireless, 2, 7, 4, 4)
